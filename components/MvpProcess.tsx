...
const processSteps = [
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1553877522-43269d4ea984?w=600&h=400&fit=crop",
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=600&h=400&fit=crop",
      ...
      <div className='max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            A systematic approach to validate and build successful products through proven methodologies
          </p>
        </motion.div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {processSteps.map((step, index) => {
            ...
            const shouldUseGradient = index !== 1 && index !== 3;
              ...
              >
                ...
                <div 
                  className={`relative overflow-hidden rounded-3xl p-6 h-80 shadow-lg ${
                    shouldUseGradient ? 'bg-gradient-to-br from-emerald-400 to-emerald-500' : ''
                  }`}
                ...
                >
                  ...
                  <div className='absolute rounded-full opacity-20' style={{
                    ...
                    top: '24rem',
                    right: '6rem',
                    border: '1px solid rgb(33, 205, 153)',
                  ...
                  <div className='absolute inset-0 opacity-20'>
                    ...
                    >
                      ...
                      <path
                        ...
                        stroke={index === 1 || index === 3 ? "rgba(0,0,0,0.3)" : "rgba(255,255,255,0.3)"}
                        strokeWidth="2"
                        fill="none"
                      />
                      <path
                        d="M-50 150 Q150 100 350 150 T650 150"
                        stroke={index === 1 || index === 3 ? "rgba(0,0,0,0.2)" : "rgba(255,255,255,0.2)"}
                        strokeWidth="1.5"
                        fill="none"
                      />
                      <path
                        d="M-50 200 Q150 150 350 200 T650 200"
                        stroke={index === 1 || index === 3 ? "rgba(0,0,0,0.15)" : "rgba(255,255,255,0.15)"}
                        strokeWidth="1"
                        fill="none"
                      />
                      <path
                        d="M-50 250 Q150 200 350 250 T650 250"
                        stroke={index === 1 || index === 3 ? "rgba(0,0,0,0.1)" : "rgba(255,255,255,0.1)"}
                        strokeWidth="1"
                        fill="none"
                      />
                    </svg>
                  ...
                  {/* Image Container */}
                  <div className='relative mb-4 rounded-2xl overflow-hidden h-32 bg-white/10 backdrop-blur-sm z-10'>
                    <img
                      src={step.imageSrc}
                      alt={step.title}
                    ...
                    {/* Icon Overlay */}
                    <div className={`absolute top-3 left-3 p-2 ${textColors.iconBg} backdrop-blur-sm rounded-xl`}>
                      <Icon className={`w-5 h-5 ${textColors.iconText}`} />
                    </div>

                    {/* Step Number */}
                    <div className={`absolute top-3 right-3 w-7 h-7 ${textColors.numberBg} backdrop-blur-sm rounded-full flex items-center justify-center`}>
                      <span className={`${textColors.numberText} font-bold text-sm`}>{step.id}</span>
                    </div>
                  </div>
                  ...
                  >
                    <h3 className={`text-xl font-bold ${textColors.title} mb-2`}>
                      {step.title}
                    </h3>
                    <p className={`${textColors.description} text-sm leading-relaxed`}>
